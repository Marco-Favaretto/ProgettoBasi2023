...
('Brasile', 'Statuetta', TRUE),
('Brasile', 'Cartolina', TRUE),
('Brasile', 'Quadretto', FALSE),
('Brasile', 'Tazza', TRUE),
('Brasile', 'Penna', FALSE),
('Brasile', 'Agenda', TRUE),
('Brasile', 'Borsa', TRUE),
('Brasile', 'CoverCellulare', TRUE),
('Brasile', 'Libro', FALSE),
('Brasile', 'Poster', FALSE),
('Brasile', 'Quadro', FALSE),
('Brasile', 'RiproduzioneArchitettonica', FALSE),
('Cina', 'Statuetta', TRUE),
('Cina', 'Cartolina', TRUE),
('Cina', 'Quadretto', TRUE),
('Cina', 'Tazza', FALSE),
